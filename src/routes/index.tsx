      ...
      <section id="top" className="border-b border-border">
        ...
        >
          ...
          <div className="relative mx-auto flex min-h-[86svh] max-w-[1600px] flex-col items-center justify-center px-5 py-20 text-center sm:px-8 lg:px-12">
            <BrandMark
              className={cn(
                "mb-5 h-40 w-40 sm:h-52 sm:w-52 md:h-60 md:w-60 [filter:drop-shadow(0_4px_18px_rgba(250,247,238,0.85))_drop-shadow(0_2px_6px_rgba(28,42,28,0.35))]",
                showSource && "text-primary-foreground",
              )}
            />
            <p
              className={cn(
                "font-display font-semibold text-[clamp(3.5rem,9vw,8rem)] uppercase leading-none tracking-[0.18em] [text-shadow:0_2px_4px_rgba(250,247,238,0.95),0_0_22px_rgba(250,247,238,0.85),0_2px_14px_rgba(28,42,28,0.35)]",
            ...
            <p
              className={cn(
                "mt-4 text-xs font-semibold uppercase tracking-[0.32em] sm:text-sm [text-shadow:0_1px_3px_rgba(250,247,238,0.95),0_0_12px_rgba(250,247,238,0.8)]",
                showSource ? "text-primary-foreground/90" : "text-foreground",
              )}
            >
            ...
            <h1
              className={cn(
                "max-w-5xl font-sans text-2xl font-bold uppercase tracking-[0.22em] sm:text-4xl md:text-5xl [text-shadow:0_2px_6px_rgba(250,247,238,0.98),0_0_28px_rgba(250,247,238,0.9),0_3px_18px_rgba(28,42,28,0.4)]",
                showSource ? "text-primary-foreground" : "text-foreground",
              )}
            >
              {showSource
            ...
            <p
              className={cn(
                "mt-6 max-w-2xl text-sm font-bold uppercase tracking-[0.16em] sm:text-base [text-shadow:0_1px_4px_rgba(250,247,238,0.98),0_0_18px_rgba(250,247,238,0.9),0_2px_10px_rgba(28,42,28,0.35)]",
